...
st.caption(
    "Ваш AI-помічник для тренувань, харчування "
...
def extract_activity(text: str) -> str | None:
    ...
    activity_patterns = {
        "мінімальна": [
            r"\bмінімальн\w*\s+активн\w*",
            r"\bсидяч\w*\s+(?:робот\w*|спосіб\w*)",
            r"\bсидж\w*.*(?:комп['’]?ютер\w*|ноутбук\w*)",
...
with st.sidebar:
    ...
    st.markdown(
        ...
        **Приклади запитів:**
        ...
        - Я жінка, мені 20 років, важу 65 кг, зріст 178 см.
        - У мене сидяча робота.
        - Хочу зробити талію тоншою.
        - Скільки калорій мені потрібно?
        - Покажи вправи на груди вдома.
        """
    )
